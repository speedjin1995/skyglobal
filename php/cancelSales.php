...
if(isset($_POST['salesID'])){
    ...
    if ($update_stmt = $db->prepare("UPDATE sales SET cancelled_datetime=? WHERE id=?")) {
        $update_stmt->bind_param('ss', $cancelled_datetime, $salesID);
        ...
        if (! $update_stmt->execute()) {
            ...
            $action = "User : ".$name." Cancel Sale with Quotation No : ".$quotationId." in sales table!";
